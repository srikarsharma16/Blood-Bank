          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="<?php
                        ...
                        <li class="<?php if(isset($setMemberActive)){ echo $setMemberActive; } else { echo ''; } ?>">
                            <a href="member.php">Organization Administrators</a>
                        </li>

                        <li class="<?php if(isset($setBloodbankActive)){ echo $setBloodbankActive; } else { echo ''; } ?>">
                            <a href="bloodbanks.php">Blood Banks</a>
                        </li>

                        <li class="<?php if(isset($setNeedBloodActive)){ echo $setNeedBloodActive; } else { echo ''; } ?>">
                            <a href="request_blood.php">Need Blood</a>
                        </li>
